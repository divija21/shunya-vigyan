    ...
    <Navbar className="navbar navbar-light bg-light relative z-6">
      ...
      <Navbar.Collapse id="basic-navbar-nav" className="justify-between">
        <div className="flex items-center space-x-4">
          ...
          <Link to="/hackthon" className="text-dark text-base">
          {language === "ENG" ? "coder hackathon" : "कोडर हैकथॉन "}

          </Link>

          <Link to="/lali" className="text-dark text-base">
          {language === "ENG" ? "lali" : " लाली "}

          </Link>

          <Link to="/prepare" className="text-dark text-base">
          {language === "ENG" ? "Prepare" : " तैयारी "}

          </Link>


          <Link to="/certify" className="text-dark text-base">
          {language === "ENG" ? "Certify" : "सर्टिफिकेट "}

          </Link>


          <Link to="/JobBoard" className="text-dark text-base">
          {language === "ENG" ? "Job Board" : "जॉब बोर्ड  "}
